...
class UpdateExpensePage extends GetView<ExpenseController> {
  const UpdateExpensePage({super.key});

  @override
  Widget build(BuildContext context) {
    final expense = Get.arguments['expense'] as ExpenseEntity;
    controller.selectedCategory = expense.category;
    controller.dateController.text = expense.date.toString().substring(0,10);
    controller.id = expense.id;

    return Scaffold(
      appBar: const CustomAppBar(title: 'Update Expense'),
      body: Padding(
